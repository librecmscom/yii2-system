...
class M161221090527Create_countries_table extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%countries}}', [
            ...
            'alpha_2' => $this->string(2)->notNull()->unique(),
            'alpha_3' => $this->string(3)->notNull()->unique(),
            'number' => $this->integer(3)->notNull()->unique(),
            'iso_3166_2' => $this->string()->notNull()->unique(),
        ], $tableOptions);

        $this->batchInsert('{{%countries}}', ['name', 'alpha_2', 'alpha_3', 'number', 'iso_3166_2'], [
            ...
            ['Taiwan, Province of China[a]', 'TW', 'TWN', '158', 'ISO 3166-2:TW'],
